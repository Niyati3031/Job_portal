          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
             <li class="breadcrumb-item"><a href="admin_dashboard.php">Dasboard</a></li>
                <li class="breadcrumb-item"><a href="create_company.php">Category</a></li>
          ...
          <div style="width: 60%; margin-left: 20%; background-color: #F2F4F4;">
            ...
            <form action="" method="post" tyle="margin:3%; padding:3%;" name="customer_form" id="customer_form">
              <div class="form-group">
                <label form="Customer Email">Enter Category Name</label>
                <input type="category" name="category" id="category" value="<?php echo $category_name; ?>" class="form-control" placeholder="Enter Category Name">
              </div>
              <div class="form-group">
