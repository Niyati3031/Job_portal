        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="customers.php">Apply Jobs</a></li>
              </ol>
          </nav>
            ...
            <tr>
              <td><?php echo $row['job_title']; ?></td>
                ...
                <!-- <td><a href = "files/<?php echo $row['file']; ?>">Download File</td> -->
                  ...
                  <div class="row">
                    <div class="btn-group">
                      <a href="view_applied_jobs.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" style="margin-right:10px;"><span class="glyphicon glyphicon-eye-open"></span></a>
