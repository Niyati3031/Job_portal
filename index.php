...
?>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
                      ...
                      <form action="#" class="search-job" method="POST">
                        <div class="row">
                          <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                ...
                                <input type="text" class="form-control" placeholder="eg. Adam Scott" name="user" id="user">
                              </div>
                            </div>
                          </div>
                          <div class="col-md">
                          ...
                          <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                <input type="submit" value="Search" name="Search_User" id="Search_User" class="form-control btn btn-primary">
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  ...
                  <div><span class="icon-my_location"></span> <span><?php echo $row['state']; ?>, <?php echo $row['country']; ?></span></div>
                </div>
              </div>
      ...
      if(isset($_POST['Search_User'])){
        $user = $_POST['user'];
        if (true) {
         $sql = mysqli_query($conn,"select * from jobseeker where first_name = '".$user."'"); 
        }
        ...
        <div class="row">
          ...
          <div class="col-md-12 ftco-animate">
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                <div class="job-post-item-header d-flex align-items-center">
                  <h2 class="mr-3 text-black h3"><?php echo $row['first_name']; ?></h2>
                  <div class="badge-wrap">
                   <span class="bg-primary text-white badge py-2 px-3"><?php echo $row['mobile_number']; ?></span>
                  </div>
                </div>
                <div class="job-post-item-body d-block d-md-flex">
                  <div class="mr-3"><span class="icon-layers"></span> <a href="#"> <?php echo $row['email'] ; ?> </a></div>
                  <div><span class="icon-my_location"></span> <span><?php echo $row['dob']; ?></span></div>
                </div>
              </div>

              <div class="ml-auto d-flex">
                <a href="blog-single.php?id=<?php echo $row['job_id']; ?>" class="btn btn-primary py-2 mr-1">View</a>
                <a href="#" class="btn btn-secondary rounded-circle btn-favorite d-flex align-items-center icon">
                  <span class="icon-heart"></span>
                </a>
              </div>
