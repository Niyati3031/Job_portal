...
<html lang="en">
  ...
  <body>
    ...
    <section class="ftco-section ftco-degree-bg">
      ...
      ?>
            <?php echo $title; ?></td></h2>
            <h5><?php echo $city;?>, <?php echo $state;?>, <?php echo $country;?></h5>
            <p><?php echo $des; ?></p>

            <form action = "apply_job.php" id = "JobPortal" method="post" enctype="multipart/form-data">
              <input type="hidden" name="job_seeker" value = "<?php echo $_SESSION['email']; ?>" id = "job_seaker">
              ...
              <div class = "row">
                ...
                <input type="n umber" class = "form-control" placeholder="Contact Number" name="number" id="number">
              </div>
              <div class="col-sm-6">
                <label>Email</label>
